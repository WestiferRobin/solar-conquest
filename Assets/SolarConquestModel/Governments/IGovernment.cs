...
namespace SolarConquest
{
    ...
    public abstract class Government
    {
        ...
        public Government(Hedron avatarHedron, Particle adminFlag, Particle archFlag1, Particle archFlag2, Particle archFlag3, Particle archFlag4) {

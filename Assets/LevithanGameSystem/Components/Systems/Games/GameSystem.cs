...
public abstract class GameSystem: ISystem
{
    ...
    public UserPlayer OwnerPlayer { get; }

    public IHedron OwnerHedron => OwnerPlayer.AvatarHedron;

    public List<IPrism> OwnerPrisms => OwnerPlayer.AvatarHedron.Prisms;

    public User Owner => OwnerPlayer.User;
